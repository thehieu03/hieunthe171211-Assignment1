                    ...
                    <form action="filterbyprice" method="post">
                        <div class="mb-3">
                            <select class="form-select" name="sort">
                                <option value="asc" ${x.equals("asc") ? 'selected' : ''}>Lowest to Highest</option>
                                <option value="desc" ${x.equals("desc") ? 'selected' : ''}  >Highest to Lowest</option>
                                <option value="new"  ${x.equals("new") ? 'selected' : ''}>Newest Product</option>
                                </select>
